...
*   **핸드 감지 및 분할 (Hand Detection & Segmentation):**
    *   **시작점 감지:** 딜러가 카드를 셔플하거나, 플레이어들에게 홀 카드가 배분되는 시점을 감지합니다.
    *   **종료점 감지:** 한 플레이어가 팟을 가져가거나, 모든 플레이어가 폴드하여 카드를 딜러에게 반납하는 시점을 감지합니다.
    *   이를 위해 컴퓨터 비전(CV) 기술로 카드, 칩, 딜러의 손 움직임 등 특정 객체와 패턴을 학습하여 사용합니다.
...
#### **Phase 1: 핵심 분석 엔진 개발 (PoC, Proof of Concept)**
